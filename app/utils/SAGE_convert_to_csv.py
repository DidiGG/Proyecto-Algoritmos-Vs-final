...
def convertir_bib_a_csv(ruta_bib, carpeta_salida):
    ...
    with open(ruta_csv, "w", newline="", encoding="utf-8") as csv_file:
        ...
        # Encabezados (modifica según los campos deseados)
        writer.writerow(['author', 'title', 'journal', 'volume', 'number', 'pages', 'year', 'doi', 'URL', 'abstract'])
...
convertir_varios_bib_a_csv(
    r"C:\Users\didie\OneDrive\Documents\Bases de datos Algoritmos\bases vf\SAGE",
