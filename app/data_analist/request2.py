...
file_path = 'ruta_del_archivo/bases_unificadas_ok.csv'
data = pd.read_csv(file_path)

# Definir palabras clave para cada categoría
categories_keywords = {
    'Habilidades': ['abstraction', 'algorithm', 'algorithmic thinking', 'coding', 'collaboration', 
                    'cooperation', 'creativity', 'critical thinking', 'debug', 'decomposition', 
                    'evaluation', 'generalization', 'logic', 'logical thinking', 'modularity', 
                    'pattern recognition', 'problem solving', 'programming', 'representation', 
                    'reuse', 'simulation'],
    'Conceptos Computacionales': ['conditionals', 'control structures', 'directions', 'events', 
    ...
    'Propiedades Psicométricas': ['classical test theory', 'confirmatory factor analysis', 
                                  'exploratory factor analysis', 'item response theory', 
                                  'reliability', 'structural equation model', 'validity'],
    'Herramienta de Evaluación': ['bctt', 'escas', 'cctt', 'ctst', 'cta-ces', 'ctc', 'ctls', 
                                  'cts', 'ctt-es', 'ctt-lp', 'capct', 'ict competency test', 
                                  'general self-efficacy scale', 'stem-las'],
    'Diseño de Investigación': ['experimental', 'longitudinal research', 'mixed methods', 
                                'post-test', 'pre-test', 'quasi-experiments', 'non-experimental'],
    'Nivel de Escolaridad': ['upper elementary education', 'primary school', 
                             'early childhood education', 'secondary school', 
                             'high school', 'university', 'college'],
    'Medio': ['block programming', 'mobile application', 'pair programming', 'plugged activities', 
              'programming', 'robotics', 'spreadsheet', 'stem', 'unplugged activities'],
    'Estrategia': ['construct-by-self mind mapping', 'design-based learning', 'gamification', 
                   'reverse engineering', 'technology-enhanced learning', 'collaborative learning', 
                   'cooperative learning', 'flipped classroom', 'game-based learning', 
